...
export class DataCountLayer {
    ...
    addMarkers(features) {
        ...
        for (let tempPoiIndex in features) {
            ...
            tempFeature = new ol.Feature({
                ...
                featureType: LayerFeatureType.dataCountFeature,
        ...
        if (!this.markerLayer) {
            ...
            this.markerLayer.set(LayerCatalogItem.sortFieldName, 11000);
    ...
    _findFeatureById(featureId) {
        ...
        let features = DataCountLayer.markerLayer.getSource().getFeatures();
...
DataCountLayer.markerLayer = null;

DataCountLayer.field_bindingObject = "bindingObject";