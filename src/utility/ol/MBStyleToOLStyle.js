...
import { deg2rad, defaultResolutions, getZoomForResolution, wrapText, applyLetterSpacing } from 'ol-mapbox-style/util';
...
function evaluateFilter(layerId, filter, feature, zoom) {
    ...
    zoomObj.zoom = zoom;
    return filterCache[layerId].filter(zoomObj, feature);
}
